...
action = input('Your at a cross road. Where do you want to go? Type "left" or "right\n').lower()
if action == "left":
...
An ugly ogre invites you to dinner and makes you have a bad night. Game over''')
...
You try to swim across, but a crocodile eats you. Game over''')
